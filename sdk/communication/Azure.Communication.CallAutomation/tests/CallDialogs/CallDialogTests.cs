...
namespace Azure.Communication.CallAutomation.Tests.CallDialogs
{
    public class CallDialogTests : CallAutomationTestBase
    {
        ...
        private static readonly StartDialogOptions _startDialogWithIdOptionsWithoutBotAppId = new StartDialogOptions(dialogId, DialogInputType.PowerVirtualAgents, new Dictionary<string, object>())
        {
            OperationContext = "context"
        };
